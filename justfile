...
backend port="51080":
    SERVER_PORT={{port}} UI_TITLE="Server Console" UI_USERMENU_ENABLED=true UI_USERMENU_ACCOUNTURL="https://iam.demo.m3.nexiona.io/realms/server/account" UI_USERMENU_LOGOUTURL="https://console.demo.m3.nexiona.io/oauth2/sign_out" UI_SOCIALLINKS_ENABLED=false DYNAMIC_CONFIG_ENABLED=true ./gradlew :api:bootRun

# Run backend with debug enabled
backend-debug port="51080":
    SERVER_PORT={{port}} UI_TITLE="Server Console" UI_USERMENU_ENABLED=true UI_USERMENU_ACCOUNTURL="https://iam.demo.m3.nexiona.io/realms/server/account" UI_USERMENU_LOGOUTURL="https://console.demo.m3.nexiona.io/oauth2/sign_out" UI_SOCIALLINKS_ENABLED=false DYNAMIC_CONFIG_ENABLED=true ./gradlew :api:bootRun --debug-jvm
...
backend-with-kafka port="51080":
    SERVER_PORT={{port}} UI_TITLE="Server Console" UI_USERMENU_ENABLED=true UI_USERMENU_ACCOUNTURL="https://iam.demo.m3.nexiona.io/realms/server/account" UI_USERMENU_LOGOUTURL="https://console.demo.m3.nexiona.io/oauth2/sign_out" UI_SOCIALLINKS_ENABLED=false KAFKA_CLUSTERS_0_NAME=local KAFKA_CLUSTERS_0_BOOTSTRAPSERVERS=localhost:9092 KAFKA_CLUSTERS_0_SCHEMAREGISTRY=http://localhost:8081 ./gradlew :api:bootRun
